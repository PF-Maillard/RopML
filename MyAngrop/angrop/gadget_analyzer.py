...
class GadgetAnalyzer:
    ...
    def ClassifierOnBlock(self, MyBlock):
        NewGadget = {}
        ...
        Xt = self.Vectorizer.transform([NewGadget])
        ClassifierResult = self.Classifier.predict_proba(Xt)
        return ClassifierResult[0][1]

    @rop_utils.timeout(10)
    def analyze_gadget(self, addr):
        ...
        try:
            ...
            #PERSO: recuperation du block
            this_gadget.block = MyBlock
    ...
    def analyze_gadget_with_ML(self, addr):
        """
        :param addr: address to analyze for a gadget
        :return: a RopGadget instance
        """
